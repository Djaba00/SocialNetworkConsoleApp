...
namespace SocialNetwork.BLL.Services
{
    public class MessageService
    {
        ...
        public IEnumerable<Message> GetOutgoingMessagesByUserId(int senderId)
        {
            ...
            {
                var senderEntity = userRepository.FindById(m.sender_id);
                var recipientUserEntity = userRepository.FindById(m.recipient_id);

                messages.Add(new Message(m.id, m.content, senderEntity.email, recipientUserEntity.email));
            });
        ...
        public void SendMessage(MessageSendingData messageSendingData)
        {
            ...
            var messageEntity = new MessageEntity()
            {
                ...
                recipient_id = messageSendingData.SenderId
            };
